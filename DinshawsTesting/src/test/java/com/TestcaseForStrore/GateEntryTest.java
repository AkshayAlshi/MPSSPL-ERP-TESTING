...
public class GateEntryTest extends Base {
	 ...
	 XLUtils1 reader = new XLUtils1();
	    ...
	    public GateEntryTest() throws IOException {
	        super();
	    ...
	    public void setup() throws Exception {
	        initialization();
	        Thread.sleep(2000);
	        selectModuleNameForAdminWithForm(prop.getProperty("ModlueXpath-GateEntryTest"), prop.getProperty("SubModuleXapath-GateEntryTest"), prop.getProperty("FormNameXpath-GateEntryTest"));
	    }
