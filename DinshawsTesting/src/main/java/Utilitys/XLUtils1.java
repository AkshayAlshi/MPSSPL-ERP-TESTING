...
public class XLUtils1 {
	...
	// static final //logger //log = //logger.get//logger(XLUtils.class);
	...
	// public void setCellData(String xlfile, String xlsheet, int rownum, int
	// colnum, String data)
	public void setCellData(String xlfile, int rownum, int colnum, String data) {

		try (FileInputStream file = new FileInputStream(new File(xlfile));
				XSSFWorkbook workbook = new XSSFWorkbook(file);
				FileOutputStream outFile = new FileOutputStream(new File(xlfile))) {
	...
	// String file = null;
	//
	// String timeStamp = new SimpleDateFormat("HH_mm_ss_MM_dd_yyyy").format(new
	// Date());
	//
	// File fileName = new File(System.getProperty("user.dir") + Constant.EXCELPATH
	// + "_" + ExecutionResult.suitename
	// + "_" + timeStamp + ".xlsx");
	// try (FileOutputStream fos = new FileOutputStream(fileName); XSSFWorkbook
	...
	// String cellData = "";
	// String userDetails = System.getProperty("user.dir"); //
	// Constant.//logINDETAILS;
	...
	// public List<String> getDetails(List<String> input, int rowNumber, String
	// sheetName, XLUtils xl, String filepath)
	// throws Exception {
	...
	//
	// result.add(xl.ReadUsingColName(filepath, sheetName, rowNumber,
	// input.get(i)));
	//
	// }
	// }
